...
> 구조 개편: 2026-09-10 (SEO·AEO·GEO 반영, 예금/고정금리 편은 별도 글로 분리)
> 카테고리: 재테크 기초
...
사이에 두 번의 기다림이 있기 때문이에요.

하나는 **은행이 돈을 구해온 비용이 한 달에 한 번만 발표된다는 것**입니다. 그 숫자를 코픽스라고 부릅니다.

다른 하나는 **내 대출에 「금리가 바뀌는 날」이 따로 정해져 있다는 것**이고요. 보통 6개월이나 12개월에 한 번 돌아옵니다.
...
고정금리라면 이번 인상과 상관없습니다. 아래 이야기는 변동금리 대출 기준으로 볼게요.
...
4월에 2.89%였던 게 7월에는 3.18%가 됐습니다. 0.29%포인트 오른 거예요.
...
이번에 기준금리는 2.50%에서 3.00%가 됐습니다. **0.5%포인트** 오른 거예요.

「0.5% 올랐다」와는 다른 말입니다. 퍼센트끼리의 차이는 헷갈리지 않게 **퍼센트포인트**로 씁니다.

그 0.5%포인트가 대출금리에 그대로 전해진다고 치면 이렇게 됩니다.
...
3억원을 빌렸다면 한 달에 12만 5천원 정도가 더 나가는 셈이에요.
...
3억원을 빌렸고 그만큼 대출금리에 그대로 전해진다면 1년에 약 150만원, 한 달에 약 12만 5천원입니다. 이자만 놓고 본 단순 계산입니다.
[/문답]
