...
내 대출이 고정금리인지 변동금리인지, 변동금리라면 몇 개월마다 바뀌는지, 그리고 다음 금리변경일이 언제인지만 보면 됩니다.
...
**내 대출의 다음 금리변경일을 확인해보세요.**

은행 앱이나 대출 약정서에서 볼 수 있습니다.

그 날짜를 알아두면 다음에 "기준금리가 올랐다"는 뉴스를 봤을 때,
...
**① 기준금리가 올랐다고 내 대출금리가 바로 오르는 건 아니었습니다.**

코픽스라는 중간 단계를 거치고, 내 대출의 금리변경일까지 기다려야 합니다.

**② 지금 이자가 그대로라고 해서 영향이 없는 건 아닙니다.**

아직 제 차례가 오지 않았을 뿐이었어요.

**③ 앞으로 얼마나 오를지는 아직 알 수 없습니다.**

기준금리가 오른 만큼 대출금리가 그대로 따라가는 것도 아니고요.

**④ 그래서 지금 할 일은 하나입니다.**

내 대출의 다음 금리변경일을 확인해두기.

---

## 자료 확인

이 글의 금리 수치는 한국은행 경제통계시스템(ECOS)과 전국은행연합회 COFIX 공시 원자료에서 확인했습니다.
...
본문의 이자 계산은 빌린 돈에 금리차를 곱한 **대략적인 계산**이며, 실제 상환액은 갚는 방식과 남은 기간, 은행별 조건에 따라 달라집니다.
