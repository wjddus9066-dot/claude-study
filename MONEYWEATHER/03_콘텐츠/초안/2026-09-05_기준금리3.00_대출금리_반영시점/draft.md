...
> 스타일 개편: 2026-09-11 (결론부터 · FAQ 첫 문장 답 · 오늘 1분 체크)
> 카테고리: 오늘의 머니온도
> 이 글의 모든 수치는 2026년 9월 6일 조회 기준입니다.

<!-- 용어확인
기준금리 — 1장 첫 문장. 「한국은행이 정하는 "돈의 기본 값"」
코픽스 — 3장. 「은행들의 평균 조달 원가표」, 매월 15일 발표까지 같은 자리에서
COFIX — 코픽스와 같은 말. 핵심 요약 박스에서 괄호로 병기
고정금리 — 2장. 「처음 정한 금리가 만기까지 그대로」
변동금리 — 2장. 「정해진 주기마다 금리를 다시 계산」
-->
...
따라서 8월 27일에 오른 기준금리가 내 이자에 닿는 건 **빨라도 10월**이며, 내 대출 조건에 따라 내년에 반영될 수도 있습니다.
[/정답]
...
**A. 8월 27일 인상이라면 빨라도 10월이에요.** 변동금리 대출은 두 가지를 거쳐야 하거든요. 먼저 코픽스 같은 지표금리에 들어가고, 그다음 내 대출의 금리 바뀌는 날이 와야 합니다. 대출 조건에 따라 더 늦어질 수도 있어요.

Q. 기준금리가 올랐는데 이자가 그대로면 은행이 실수한 건가요?
**A. 아닙니다.** 원래 이렇게 시간이 걸리는 구조예요. 지표금리가 한 달에 한 번만 나오고, 내 대출도 정해진 날에만 금리를 다시 계산하거든요.

Q. 코픽스는 언제 발표되나요?
**A. 매월 15일이에요.** 전국은행연합회가 공시하고, 이때 나오는 숫자는 그 전달을 기준으로 계산한 값이에요. 9월 15일에 나오는 건 8월 숫자입니다.

Q. 고정금리 대출도 기준금리가 오르면 이자가 오르나요?
**A. 오르지 않습니다.** 고정금리는 처음 정한 금리가 끝까지 그대로 가요. 기준금리를 따라 움직이는 건 변동금리 쪽입니다.
...
**A. 3억원을 빌렸다면 한 달에 약 12만 5천원이에요.** 오른 만큼 대출금리에 그대로 전해진다고 가정하면 1년에 약 150만원입니다. 이자만 놓고 본 단순 계산이에요.
[/문답]
...
- **고정금리인지 변동금리인지** 확인합니다. (고정이면 편안하게 주무시면 됩니다.)
- 변동금리라면 **어떤 지표를 쓰는지** 확인합니다. (예: 코픽스 6개월, 금융채 1년 등)
- **다음 금리 변경일**을 내 캘린더에 적어둡니다.
- 예상되는 이자 증가분만큼 이번 달부터 미리 **비상금(예비비)**을 조금씩 늘려둡니다.
[/체크]

<!-- 2026-09-11 사용자 지정: 「💡 핵심 요약」 박스와 「결론」부터 「참고해주세요」 끝까지는
     제미나이 판(00_브랜드/제미나이스타일 오늘의머니온도글작성.html)을 스타일까지 그대로 쓴다.
     바꾼 곳은 사실이 틀린 한 군데 — 자료 출처에 국가데이터처(물가·가계동향 수치의 출처)와 기준일을 더했다.
     자료 출처가 면책 상자 안에 들어가서 [FOOTER] 는 뺐다. -->
